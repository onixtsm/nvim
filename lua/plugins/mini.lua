return {
  ...
  -- File explorer (this works properly with oil unlike nvim-tree)
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>ee", MiniFiles.open, { desc = "Open mini file explorer" }) -- toggle file explorer
      vim.keymap.set("n", "<leader>es", MiniFiles.synchronize, { desc = "Sync mini file explorer" }) -- toggle file explorer
